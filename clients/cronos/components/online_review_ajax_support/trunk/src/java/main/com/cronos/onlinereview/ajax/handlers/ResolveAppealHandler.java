...
public class ResolveAppealHandler extends ReviewCommonHandler {
    ...
    /**
     * <p>
     * Represents the mapping of evaluation types. The key is the name of the evaluation type,
     * the value is the evaluation type instance.
     * </p>
     */
    ...
    /**
     * <p>
     * Gets string array parameter from the request.
     * </p>
     * 
     * @param request the request instance.
     * @param paramPrefix the prefix of the parameter key
     * @return the string array of the parameter
     */
